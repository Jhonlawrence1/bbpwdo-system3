...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sql = "INSERT INTO pwd_records (
            ...
            is_registered, employment_status, employment_type, education_elementary,
            education_highschool, education_college, education_vocational, disability_type,
            assistive_device, guardian_name, guardian_relationship, guardian_contact,
            guardian_address, skills, trainings
        ) VALUES (
            :last_name, :first_name, :middle_name, :suffix, :sex, :age, :birthdate, :blood_type,
            :civil_status, :contact_number, :address, :pwd_id_number, :issued_date, :expiry_date,
            :is_registered, :employment_status, :employment_type, :education_elementary,
